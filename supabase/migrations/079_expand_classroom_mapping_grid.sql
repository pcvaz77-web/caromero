-- CARÔMETRO COMERCIAL
-- Amplia o mapeamento para até 20 fileiras e 30 carteiras por fileira.
...
begin
  ...
  if v_rows not between 1 and 20 or v_columns not between 1 and 30 then
    raise exception 'O mapeamento deve ter entre 1 e 20 fileiras e entre 1 e 30 carteiras por fileira.';
  end if;
