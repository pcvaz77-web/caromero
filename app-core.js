...
let user;
const emptySchoolPermission = () => ({ role:'viewer', is_coordinator:false, can_add_students:false, can_edit_students:false, can_use_siap_assistant:false, can_import_siap_attendance:false, can_prepare_school_year:false });
