document.addEventListener('DOMContentLoaded', () => {
  ...
  const extensionLink = modal.querySelector('.sda-actions a[download]');
  extensionLink.removeAttribute('download');
