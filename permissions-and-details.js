document.addEventListener('DOMContentLoaded', () => {
  ...
  const occCheck = (item, occMap, key, label) => {
    ...
    const disabled = admin || !target || target.member_status !== 'active' || !!target.can_edit_all;
