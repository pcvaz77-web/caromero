document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    .uniform-modal { z-index:110; inset:0!important; padding:0!important; align-items:stretch!important; overscroll-behavior:none; }.uniform-dialog { width:100vw; height:100dvh; max-height:100dvh; min-height:0; display:flex; flex-direction:column; overflow:hidden; }.uniform-dialog .modal-head { position:relative!important; top:auto!important; flex:none; }
    ...
    .uniform-dialog { border-radius:0; background:#fff; box-shadow:none; }
    ...
    @media(min-width:801px) {
      ...
      .uniform-summary { gap:8px; padding:5px 22px 6px; }.uniform-summary > div { position:relative; min-height:54px; display:flex; flex-direction:column; align-items:center; justify-content:flex-start; gap:2px; padding:6px 8px 18px; border-radius:12px; text-align:center; }.uniform-summary > div > .uniform-icon { width:23px; height:23px; margin-inline:auto; }.uniform-summary span:not(.uniform-icon):not(.uniform-icon-pair) { width:100%; font-size:10px; line-height:1.05; text-align:center; white-space:normal; }.uniform-summary b { position:absolute; left:9px; bottom:5px; font-size:16px; line-height:1; }.uniform-summary .uniform-icon-pair { min-height:23px; align-self:center; justify-content:center; margin-inline:auto; }
