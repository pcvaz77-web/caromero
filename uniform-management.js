document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    @media(max-width:800px) {
      ...
      .uniform-dialog .uniform-modern-head { min-height:112px; padding:20px; }.uniform-modern-head > .uniform-icon { width:48px; height:48px; }.uniform-modern-head h3 { font-size:21px; }.uniform-modern-head .meta { font-size:13px; }
      .uniform-mode-toggle { width:calc(100% - 32px); margin:16px; }.uniform-mode-btn { min-width:0; flex:1; min-height:44px; }
      .uniform-summary { grid-template-columns:repeat(2,1fr); gap:10px; padding:10px 16px 16px; }.uniform-summary > div { min-height:100px; grid-template-columns:40px 1fr; padding:12px; }.uniform-summary > div > .uniform-icon { width:36px; height:36px; }.uniform-summary span:not(.uniform-icon) { font-size:12px; }.uniform-summary b { font-size:22px; }
      .uniform-shift-section { margin:0 16px; padding:14px; }.uniform-shift-summary { display:grid; grid-template-columns:1fr; gap:8px; }.uniform-shift-card { display:block; }.uniform-shift-card > b { display:flex; font-size:13px; }.uniform-shift-values { display:grid; grid-template-columns:repeat(4,1fr); gap:4px; }.uniform-shift-cell { display:flex!important; flex-direction:column; gap:2px; min-height:47px; }.uniform-shift-values span { font-size:9px; }.uniform-shift-values strong { font-size:16px; }
