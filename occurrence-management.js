document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    @media(max-width:800px) { .side .nav #occurrenceNav { flex:1 1 0!important; min-width:0; }.occurrence-modal.hidden { display:none!important; }.occurrence-modal:not(.hidden) { height:100dvh!important; max-height:100dvh!important; padding:10px!important; align-items:center!important; justify-content:center!important; overflow:hidden!important; overscroll-behavior:none; pointer-events:auto!important; }.occurrence-dialog { width:100%; height:calc(100dvh - 20px); max-height:none!important; min-height:0; margin:0; display:flex; flex-direction:column; overflow:hidden!important; pointer-events:auto!important; }.occurrence-dialog .modal-head { position:sticky!important; top:0!important; z-index:4!important; flex:none; padding:16px; background:#fff!important; }.occurrence-form { min-height:0; flex:1 1 auto; overflow-y:auto!important; -webkit-overflow-scrolling:touch; overscroll-behavior:contain; padding:16px; pointer-events:auto!important; }.occurrence-dialog button,.occurrence-dialog input,.occurrence-dialog select,.occurrence-dialog textarea { pointer-events:auto!important; }.occurrence-grid,.occurrence-dates { grid-template-columns:1fr; gap:0; }.occurrence-actions { display:grid; grid-template-columns:1fr; gap:8px; }.occurrence-actions .btn { width:100%; }.occurrence-text-meta { flex-direction:column; gap:3px; }.occurrence-history-list { max-height:34vh; }.occurrence-item-head { flex-direction:column; gap:3px; } }
  `;
