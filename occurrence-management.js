document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    @media(max-width:800px) { .side .nav #occurrenceNav { flex:1 1 0!important; min-width:0; }.occurrence-modal { padding:10px!important; align-items:start!important; overflow-y:auto!important; overscroll-behavior:contain; }.occurrence-dialog { width:100%; height:calc(100dvh - 20px); max-height:none!important; margin:0; display:flex; flex-direction:column; overflow:hidden!important; }.occurrence-dialog .modal-head { position:relative!important; top:auto!important; flex:none; padding:16px; }.occurrence-form { min-height:0; flex:1 1 auto; overflow-y:auto; overscroll-behavior:contain; padding:16px; }.occurrence-grid,.occurrence-dates { grid-template-columns:1fr; gap:0; }.occurrence-actions { display:grid; grid-template-columns:1fr; gap:8px; }.occurrence-actions .btn { width:100%; }.occurrence-text-meta { flex-direction:column; gap:3px; }.occurrence-history-list { max-height:34vh; }.occurrence-item-head { flex-direction:column; gap:3px; } }
  `;
