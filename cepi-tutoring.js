document.addEventListener('DOMContentLoaded', () => {
  ...
  formModal.innerHTML = `<section class="modal cepi-form-dialog"><div class="modal-head"><div><span class="cepi-kicker">FICHA INDIVIDUAL</span><h3 id="cepiFormTitle">Novo atendimento</h3><div class="cepi-form-student"><strong id="cepiFormStudentName"></strong><span class="meta" id="cepiFormStudentClass"></span><div id="cepiFormStudentLabels" class="cepi-form-student-labels"></div></div></div><button class="close" type="button" data-cepi-close="cepiFormModal">×</button></div><form id="cepiAttendanceForm" class="form"><input id="cepiFormAssignment" type="hidden"><input id="cepiFormId" type="hidden">
    <div class="cepi-form-section"><h4>Identificação e projetos</h4><div class="cepi-filter-grid"><div class="field"><label for="cepiFormDate">Data do atendimento</label><input id="cepiFormDate" type="date" required></div><div class="field"><label>Turma</label><input id="cepiFormClass" readonly></div></div><div class="cepi-filter-grid"><div class="field"><label for="cepiScientific">Iniciação Científica (EF)</label><input id="cepiScientific"></div><div class="field"><label for="cepiLifeProject">Projeto de Vida (EM)</label><input id="cepiLifeProject"></div></div><h4>Projeto de Eletiva</h4><div class="cepi-project-terms"><div class="field"><label for="cepiElective1">1º bimestre</label><input id="cepiElective1"></div><div class="field"><label for="cepiElective2">2º bimestre</label><input id="cepiElective2"></div><div class="field"><label for="cepiElective3">3º bimestre</label><input id="cepiElective3"></div><div class="field"><label for="cepiElective4">4º bimestre</label><input id="cepiElective4"></div></div><h4>PJ</h4><div class="cepi-project-terms"><div class="field"><label for="cepiPj1">1º bimestre</label><input id="cepiPj1"></div><div class="field"><label for="cepiPj2">2º bimestre</label><input id="cepiPj2"></div><div class="field"><label for="cepiPj3">3º bimestre</label><input id="cepiPj3"></div><div class="field"><label for="cepiPj4">4º bimestre</label><input id="cepiPj4"></div></div></div>
  ...
  style.textContent = `
    ...
    .cepi-project-terms{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.cepi-form-student{display:flex;align-items:center;flex-wrap:wrap;gap:7px;margin-top:7px}.cepi-form-student>strong{font-size:18px;line-height:1.25;color:var(--navy)}.cepi-form-student-labels{display:flex;align-items:center;flex-wrap:wrap;gap:6px}.cepi-form-student-labels span{display:inline-flex;align-items:center;padding:4px 8px;border-radius:99px;background:#d1fae5;color:#047857;font-size:12px;font-weight:750}.student-tutor-detail-label{margin-left:7px;vertical-align:middle}
  ...
  const attendanceSchema = [
    ...
    { id:'elective_1', label:'Projeto de Eletiva — 1º bimestre' },
    { id:'elective_2', label:'Projeto de Eletiva — 2º bimestre' },
    { id:'elective_3', label:'Projeto de Eletiva — 3º bimestre' },
    { id:'elective_4', label:'Projeto de Eletiva — 4º bimestre' },
    { id:'pj_1', label:'PJ — 1º bimestre' },
    { id:'pj_2', label:'PJ — 2º bimestre' },
    { id:'pj_3', label:'PJ — 3º bimestre' },
    { id:'pj_4', label:'PJ — 4º bimestre' },
  ...
  const formFieldMap = {
    ...
    elective_3:'cepiElective3', elective_4:'cepiElective4', pj_1:'cepiPj1', pj_2:'cepiPj2', pj_3:'cepiPj3', pj_4:'cepiPj4',
    narrative:'cepiNarrative', agreements:'cepiAgreements', subject:'cepiSubject',
  ...
  async function openAttendanceForm(assignmentId, existingForm=null) {
    ...
    if (existingForm) fillAttendanceAnswers(existingForm.answers || {});
      ...
      fillAttendanceAnswers({ scientific_initiation:previous.scientific_initiation, life_project:previous.life_project, elective_1:previous.elective_1, elective_2:previous.elective_2, elective_3:previous.elective_3, elective_4:previous.elective_4, pj_1:previous.pj_1, pj_2:previous.pj_2, pj_3:previous.pj_3, pj_4:previous.pj_4, acknowledged_name:student.name });
    }
