...
test('CEPI frontend is loaded explicitly', () => {
  assert.match(index, /'cepi-tutoring\.js\?v=13'/);
...
test('individual tutoring form follows the official CEPI model', () => {
  ...
  assert.match(frontend, /Projeto de Eletiva — 2º semestre/);
  assert.match(frontend, /PJ — 1º semestre/);
  assert.match(frontend, /PJ — 2º semestre/);
  assert.doesNotMatch(frontend, /Projeto de Eletiva — [34]º bimestre/);
