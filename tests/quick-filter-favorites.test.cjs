...
assert.match(source,/data-favorite-position="\$\{position\}"/);
assert.match(source,/\[data-favorite-position="1"\].*#f1faf5/);
assert.match(source,/\[data-favorite-position="2"\].*#fffaf0/);
assert.match(source,/\[data-favorite-position="3"\].*#fff4f6/);
