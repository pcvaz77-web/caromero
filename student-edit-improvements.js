document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    #profileNav, #permissionsNav { border:0; background:transparent; }
    #profileNav:hover, #profileNav:focus, #permissionsNav:hover, #permissionsNav:focus { background:#2b3c5d; color:#fff; }
